      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              A student engineering team designing, building, testing, and competing 
              in Baja SAE.
            </p>
            <p className="mt-4 text-xs text-gray-600">
              Not an official SAE International website.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/sponsors" className="text-sm text-gray-400 hover:text-white transition-colors">
                  Become a Sponsor
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <a href="mailto:vortexone@saveetha.ac.in" className="hover:text-white transition-colors">
                  vortexone@saveetha.ac.in
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          <p className="text-xs text-gray-600">
            © 2026 Vortex One - Saveetha Engineering College. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
